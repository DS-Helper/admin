...
@Setter
@Builder
public class GetScrappedBoardsResponseDto {
    ...
    public static class Board{
        ...
        public static Board toBoard(com.project.ds_helper.domain.board.entity.Board board, int commentCount, String thumbNailUrl){
