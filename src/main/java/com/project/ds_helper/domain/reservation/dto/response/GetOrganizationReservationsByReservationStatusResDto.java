...
@Schema(description = "예약 상태별 기관 예약 DTO", example = "{\"organizationReservationId\":\"org-res-001\",\"organizationName\":\"행복복지관\",\"reservationHolderId\":\"user-001\",\"reservationHolder\":\"홍길동\",\"reservationPhoneNumber\":\"010-1234-5678\",\"visitDate\":\"2026-03-30\",\"startTime\":\"14:00\",\"endTime\":\"15:00\",\"address\":\"서울특별시 강남구 테헤란로 123\",\"requirement\":\"서류 작성 지원\",\"note\":\"노트북 지참 예정\",\"reservationStatus\":\"REQUESTED\"}")
public record GetOrganizationReservationsByReservationStatusResDto(
...
//    }
        ...
        public static GetOrganizationReservationsByReservationStatusResDto fromOrgReservationToReservation(OrganizationReservation organizationReservation){
            return new GetOrganizationReservationsByReservationStatusResDto(
                    ...
                    organizationReservation.getReservationSchedule() != null? organizationReservation.getReservationSchedule().getVisitDate() : null,
                    organizationReservation.getReservationSchedule() != null? organizationReservation.getReservationSchedule().getStartTime() : null,
                    organizationReservation.getReservationSchedule() != null? organizationReservation.getReservationSchedule().getEndTime() : null,
