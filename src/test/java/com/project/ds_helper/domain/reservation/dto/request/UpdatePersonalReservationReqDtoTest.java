...
class UpdatePersonalReservationReqDtoTest {

    @Test
    @DisplayName("개인 예약 수정 요청은 기존 엔티티를 갱신한다")
    void toPersonalReservation_updatesFields() {
        UpdatePersonalReservationReqDto dto = new UpdatePersonalReservationReqDto();
        dto.setName("홍길동");
        ...
        PersonalReservation result = dto.toPersonalReservation(reservation, dto);

        assertThat(result.getName()).isEqualTo("홍길동");
        assertThat(result.getRecipientGender()).isEqualTo(RecipientGenderType.FEMALE);
